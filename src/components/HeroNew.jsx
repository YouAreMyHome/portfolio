...
import { Github as GitHub, Linkedin, Facebook, ArrowRight, Download } from 'lucide-react';
            ...
            <div className="relative">
              ...
              >
                <div className="w-64 h-64 lg:w-80 lg:h-80 rounded-full bg-gradient-to-br from-cyber-blue/20 to-cyber-purple/20 backdrop-blur-sm border border-white/10 flex items-center justify-center overflow-hidden relative">
                  ...
                  <div className="w-56 h-56 lg:w-72 lg:h-72 rounded-full bg-gradient-to-br from-gray-600 to-gray-800 flex items-center justify-center text-6xl lg:text-8xl text-white font-bold">
                    N
                  </div>
