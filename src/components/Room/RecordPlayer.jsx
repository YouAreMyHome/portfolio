  ...
  return (
    <group ref={groupRef} position={position}>
      ...
      <group position={[0, -0.35, 0]}>
        ...
        {/* Door handle */}
        <mesh  position={[0.15, 0, 0.21]} rotation={[Math.PI/2, 0, 0]}>
      ...
      <group position={[0, 0.02, 0]}>
        ...
        <group ref={armRef} position={[0.18, 0.05, -0.1]} rotation={[0, 0.15, 0]}>
          ...
          <mesh  position={[-0.09, 0.045, 0.06]} rotation={[0, 0.25, 0]}>
          ...
          {/* Counterweight */}
          <mesh  position={[0.06, 0.045, -0.02]} rotation={[0, 0, Math.PI/2]}>
