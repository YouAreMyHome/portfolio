  ...
  return (
    <group position={[1, 0, -3.6]} {...props}>
      ...
      <group position={[0, 0.18, 0]}>
         <RoundedBox  args={[1.4, 0.35, 0.35]} radius={0.02} >
      ...
      <group position={[-0.5, 0.48, 0.05]} rotation={[0, 0.2, 0]}>
         ...
         <RoundedBox  args={[0.035, 0.28, 0.22]} radius={0.005}>
      ...
      <group position={[0.5, 0.45, 0.05]}>
          <RoundedBox  args={[0.15, 0.2, 0.15]} radius={0.01}>
      ...
      <group position={[0, 1.0, 0]}>
         ...
         {/* TV Frame */}
         <RoundedBox  args={[1.2, 0.7, 0.04]} radius={0.02}>
